...
namespace YinAndYang
{
    ...
    {
        public static int blackDies = 0;
        public BlackCell(int size, Point position, int i, int j):base( size,  position,  i,  j)
        {
            this.size = size;           
            ...
            this.x = j;
            this.y = i;
            this.square.BackColor = Color.Black;          
        }

        public BlackCell(Cell cell): base(cell)
        {
